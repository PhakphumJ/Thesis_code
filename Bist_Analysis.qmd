...
I also remove firms with top and bottom 0.5% of sales per worker or top and bottom 0.5% of K/L.
...
### Trimming sample
Top and bottom 0.5% of sales per worker and K/L


```{r}
## 2555
# Calculate the 0.5% and 99.5% quantiles of sales per worker
q_2555_s_w <- weighted.quantile(BICTS_2555$sales_per_worker, probs = c(0.005, 0.995), w = BICTS_2555$wgt5)

# Calculate the 0.5% and 99.5% quantiles of K/L
q_2555_KL <- weighted.quantile(BICTS_2555$KL, probs = c(0.005, 0.995), w = BICTS_2555$wgt5)

## 2565
# Calculate the 0.5% and 99.5% quantiles of sales per worker
q_2565_s_w <- weighted.quantile(BICTS_2565$sales_per_worker, probs = c(0.005, 0.995), w = BICTS_2565$WGT)

# Calculate the 0.5% and 99.5% quantiles of K/L
q_2565_KL <- weighted.quantile(BICTS_2565$KL, probs = c(0.005, 0.995), w = BICTS_2565$WGT)
