...
I also remove firms with top and bottom 0.5% of value-added per worker or top and bottom 0.5% of K/L.
...
### Trimming sample
Top and bottom 0.5% of value-added per worker or top and bottom 0.5% of K/L.


```{r}
### Trimming those with value-added per worker in bottom 0.5% and top 0.5% or top and bottom 0.5% of K/L.

## 2550
# Calculate the 0.5% and 99.5% quantiles of value-added per worker
q_2550 <- weighted.quantile(INDUS_2550$Value_Added_per_emp, probs = c(0.005, 0.995), weights = INDUS_2550$WGT_REG)

# Calculate the 0.5% and 99.5% quantiles of K/L
q_2550_KL <- weighted.quantile(INDUS_2550$Capital_to_Labor, probs = c(0.005, 0.995), weights = INDUS_2550$WGT_REG)

## 2555
# Calculate the 0.5% and 99.5% quantiles of value-added per worker
q_2555 <- weighted.quantile(INDUS_2555$Value_Added_per_emp, probs = c(0.005, 0.995), weights = INDUS_2555$WGT17)

# Calculate the 0.5% and 99.5% quantiles of K/L
q_2555_KL <- weighted.quantile(INDUS_2555$Capital_to_Labor, probs = c(0.005, 0.995), weights = INDUS_2555$WGT17)

## 2560
# Calculate the 0.5% and 99.5% quantiles of value-added per worker
q_2560 <- weighted.quantile(INDUS_2560$Value_Added_per_emp, probs = c(0.005, 0.995), weights = INDUS_2560$WGT)

# Calculate the 0.5% and 99.5% quantiles of K/L
q_2560_KL <- weighted.quantile(INDUS_2560$Capital_to_Labor, probs = c(0.005, 0.995), weights = INDUS_2560$WGT)

## 2565
# Calculate the 0.5% and 99.5% quantiles of value-added per worker
q_2565 <- weighted.quantile(INDUS_2565$Value_Added_per_emp, probs = c(0.005, 0.995), weights = INDUS_2565$WGT)

# Calculate the 0.5% and 99.5% quantiles of K/L
q_2565_KL <- weighted.quantile(INDUS_2565$Capital_to_Labor, probs = c(0.005, 0.995), weights = INDUS_2565$WGT)
