...
Emp_Num_LF_scaled %>% gt(rowname_col = "REG", groupname_col = "Year") %>% cols_label(Avg_emp = "Average number of workers", Num_firms = "Number of firms (10,000)", Labor_Force = "Labor force (millions)") %>% cols_align(align = "center") %>% cols_width(everything() ~ px(160)) %>% fmt_number(decimals = 2) -> tab_emp_num_lf

## Save the table
gtsave(tab_emp_num_lf,"Output/emp_num_lf_Indust.html")
...
```{r}
## Let's try creating the table with gt.
KLVAPerEmp %>% gt(rowname_col = "REG", groupname_col = "Year") %>% cols_label(Avg_Capital_to_Labor = "Average K/L", Avg_Value_Added_per_emp = "Average Value-added per worker", Avg_Sales_per_emp = "Average Sales per worker") %>% cols_align(align = "center") %>% cols_width(everything() ~ px(160)) %>% fmt_number(decimals = 0) -> tab_KLVAPerEmp

## Save the table
gtsave(tab_KLVAPerEmp,"Output/KLVAPerEmp_Indust.html")
...
```{r}
# 2550
ggplot(INDUS_2550 %>% drop_na(SIZE_R)) + aes(x = SIZE_R, weight = WGT_REG, y = after_stat(prop)) + geom_bar(stat = "prop") + facet_rep_wrap(~REG, labeller = region_labeller, ncol = 1) + labs(title = "Distribution of Firm Size (by region) in 2006", x = "Number of workers", y = "Proportion") + ylim(0, 0.6)

## save the plot
ggsave("Output/Firm_size_2550_Indust.png", width = 8, height = 9)
...
# 2560
ggplot(INDUS_2560 %>% drop_na(SIZE_R)) + aes(x = SIZE_R, weight = WGT, y = after_stat(prop)) + geom_bar(stat = "prop") + facet_rep_wrap(~REG, labeller = region_labeller, ncol = 1) + labs(title = "Distribution of Firm Size (by region) in 2016", x = "Number of workers", y = "Proportion") + ylim(0, 0.6)
...
# 2565
ggplot(INDUS_2565 %>% drop_na(SIZE_R)) + aes(x = SIZE_R, weight = WGT, y = after_stat(prop)) + geom_bar(stat = "prop") + facet_rep_wrap(~REG, labeller = region_labeller, ncol = 1) + labs(title = "Distribution of Firm Size (by region) in 2021", x = "Number of workers", y = "Proportion") + ylim(0, 0.6)

## Save the plot
ggsave("Output/Firm_size_2565_Indust.png" , width = 8, height = 9)
...
## Save the plot
ggsave("Output/Sales_and_num_work_plot_Indust_eq_width.png", width = 8, height = 6)
...
## Save the plot
ggsave("Output/Sales_and_num_work_plot_eq_freq_Indust.png", width = 8, height = 6)
...
## Save the plot
ggsave("Output/Sales_and_num_work_plot_eq_freq_cut_Indust.png", width = 8, height = 6)
...
## Save the plot
ggsave("Output/KL_and_num_work_plot_Indust_eq_width.png", width = 8, height = 6)
...
## Save the plot
ggsave("Output/K_and_num_work_plot_Indust_eq_width.png", width = 8, height = 6)
...
## Save the plot
ggsave("Output/VA_and_num_work_plot_Indust_eq_width.png", width = 8, height = 6)
...
## Save the plot
ggsave("Output/VA_and_num_work_plot_eq_freq_Indust.png", width = 8, height = 6)
...
## Save the plot
ggsave("Output/Sales_per_emp_and_num_work_plot_Indust_eq_width.png", width = 8, height = 6)
...
## Save the plot
ggsave("Output/Sales_per_emp_and_num_work_plot_eq_freq_Indust.png", width = 8, height = 6)
