...
# Calculate K/L
INDUS_2550_KL_filtered <- INDUS_2550_KL_filtered %>% mutate(Capital_to_Labor = I08/num_employ)


# 2555. I05/num_employ
INDUS_2555_KL_filtered <- INDUS_2555 %>% filter(G01 > 12000, I05 > 6000, !is.na(G01), !is.na(I05), !is.na(A20), !is.na(A24))

# Calculate K/L
INDUS_2555_KL_filtered <- INDUS_2555_KL_filtered %>% mutate(Capital_to_Labor = I05/num_employ)
...
# Calculate K/L
INDUS_2560_KL_filtered <- INDUS_2560_KL_filtered %>% mutate(Capital_to_Labor = E16/num_employ)


# 2565. E16/(B04 + B08)
INDUS_2565_KL_filtered <- INDUS_2565 %>% filter(D01 > 12000, E16 > 6000, !is.na(D01), !is.na(E16), !is.na(B04), !is.na(B08))

# Calculate K/L
INDUS_2565_KL_filtered <- INDUS_2565_KL_filtered %>% mutate(Capital_to_Labor = E16/num_employ)
