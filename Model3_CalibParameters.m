...
%% Do random serch.
% Draw random combination of parameters. Do it 3,000,000 times. 
% There are 3,230,707,200 possible combination of parameter values. 
n = 3000; %(3,000 for now)
...
for t = 1:2
    ...
    % Calculate W_m * avg h in sector m
    h_in_m = (Hbar_t +  ...
    SD*pdf('Normal', ((x_star(2)/x_star(3)) - Hbar_t)/Best_SD, 0, 1)/(1- cdf('Normal', ((x_star(2)/x_star(3)) - Hbar_t)/Best_SD, 0, 1)));
...
% Calculate W_m * avg h in sector m
h_in_m = (new_H_bar_1 +  ...
SD*pdf('Normal', ((x_star_counter_case1(2)/x_star_counter_case1(3)) - new_H_bar_1)/Best_SD, 0, 1)/(1- cdf('Normal', ((x_star_counter_case1(2)/x_star_counter_case1(3)) - new_H_bar_1)/Best_SD, 0, 1)));
...
% Calculate W_m * avg h in sector m
h_in_m = (old_H_bar_1 +  ...
SD*pdf('Normal', ((x_star_counter_case2(2)/x_star_counter_case2(3)) - old_H_bar_1)/Best_SD, 0, 1)/(1- cdf('Normal', ((x_star_counter_case2(2)/x_star_counter_case2(3)) - old_H_bar_1)/Best_SD, 0, 1)));
...
% Calculate W_m * avg h in sector m
h_in_m = (new_H_bar_1 +  ...
SD*pdf('Normal', ((x_star_counter_case3(2)/x_star_counter_case3(3)) - new_H_bar_1)/Best_SD, 0, 1)/(1- cdf('Normal', ((x_star_counter_case3(2)/x_star_counter_case3(3)) - new_H_bar_1)/Best_SD, 0, 1)));
